    ...
    <div class="py-12">
        <div class="container">
            <div class="bg-white p-5 shadow-lg rounded-lg">
                ...
                <a href="{{ route('tag.create') }}" class="btn btn-primary mb-3">Adicionar Nova Tag</a>

                <!-- Formulário de Pesquisa -->
                <form action="{{ route('tag.index') }}" method="GET" class="mb-4">
                    @csrf
                        ...
                        @if($tags->isEmpty())
                            <tr>
                                <td colspan="2" class="text-center">
                                    <div class="alert alert-danger">Nenhuma tag encontrada!</div>
                                </td>
                            </tr>
                        @else
                            @foreach($tags as $tag)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('tag.edit', $tag) }}" class="btn btn-warning btn-sm">Editar</a>
                                        <a href="{{ route('confirm.delete.tag', $tag->id) }}" class="btn btn-danger btn-sm">Excluir</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
